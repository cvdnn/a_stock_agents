...
Delegates to core.commands.trade_cmds.
"""
...
import core.commands.trade_cmds as _core_mod
from core.commands.trade_cmds import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "commands.trade_cmds".replace(".", "/") + ".py"
