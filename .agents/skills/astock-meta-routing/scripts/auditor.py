...
Delegates to core.governance.auditor.
"""
...
import core.governance.auditor as _core_mod
from core.governance.auditor import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "governance.auditor".replace(".", "/") + ".py"
