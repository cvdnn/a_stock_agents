...
Delegates to core.commands.model_cmds.
"""
...
import core.commands.model_cmds as _core_mod
from core.commands.model_cmds import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "commands.model_cmds".replace(".", "/") + ".py"
