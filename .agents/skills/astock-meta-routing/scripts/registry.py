...
Delegates to core.models.registry.
"""
...
import core.models.registry as _core_mod
from core.models.registry import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "models.registry".replace(".", "/") + ".py"
