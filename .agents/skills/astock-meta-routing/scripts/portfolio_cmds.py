...
Delegates to core.commands.portfolio_cmds.
"""
...
import core.commands.portfolio_cmds as _core_mod
from core.commands.portfolio_cmds import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "commands.portfolio_cmds".replace(".", "/") + ".py"
