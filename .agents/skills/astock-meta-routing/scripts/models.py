...
Delegates to core.governance.models.
"""
...
import core.governance.models as _core_mod
from core.governance.models import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "governance.models".replace(".", "/") + ".py"
