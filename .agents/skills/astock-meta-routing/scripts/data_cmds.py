...
Delegates to core.commands.data_cmds.
"""
...
import core.commands.data_cmds as _core_mod
from core.commands.data_cmds import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "commands.data_cmds".replace(".", "/") + ".py"
