...
Delegates to core.strategy.execution_action_engine.
"""
...
import core.strategy.execution_action_engine as _core_mod
from core.strategy.execution_action_engine import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "strategy.execution_action_engine".replace(".", "/") + ".py"
