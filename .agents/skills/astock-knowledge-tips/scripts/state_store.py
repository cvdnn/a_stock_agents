...
Delegates to core.monitor.state_store.
"""
...
import core.monitor.state_store as _core_mod
from core.monitor.state_store import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "monitor.state_store".replace(".", "/") + ".py"
