...
Delegates to core.monitor.notifier.
"""
...
import core.monitor.notifier as _core_mod
from core.monitor.notifier import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "monitor.notifier".replace(".", "/") + ".py"
