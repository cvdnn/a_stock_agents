...
Delegates to core.monitor.schedule_gate.
"""
...
import core.monitor.schedule_gate as _core_mod
from core.monitor.schedule_gate import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "monitor.schedule_gate".replace(".", "/") + ".py"
