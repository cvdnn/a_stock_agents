...
Delegates to core.paper_trading.paper_trade_cli.
"""
...
import core.paper_trading.paper_trade_cli as _core_mod
from core.paper_trading.paper_trade_cli import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _target_file = (_ROOT / "scripts" / "core" if (_ROOT / "scripts" / "core").exists() else _ROOT / "core") / "paper_trading/paper_trade_cli.py"
