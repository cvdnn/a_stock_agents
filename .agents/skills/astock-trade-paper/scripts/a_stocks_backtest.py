...
Delegates to core.paper_trading.a_stocks_backtest.
"""
...
import core.paper_trading.a_stocks_backtest as _core_mod
from core.paper_trading.a_stocks_backtest import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "paper_trading.a_stocks_backtest".replace(".", "/") + ".py"
