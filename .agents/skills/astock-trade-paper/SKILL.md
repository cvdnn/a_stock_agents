...
- `ImportError: cannot import name 'TypeAlias' from 'typing'`：使用了 Python 3.9。本服务依赖 pandas，**必须使用 Python >= 3.10**。检查 `python3 --version`，用 venv 或 pyenv 切换到 3.10+。
