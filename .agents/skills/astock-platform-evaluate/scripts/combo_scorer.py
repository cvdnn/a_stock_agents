...
Delegates to core.models.combo_scorer.
"""
...
import core.models.combo_scorer as _core_mod
from core.models.combo_scorer import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "models.combo_scorer".replace(".", "/") + ".py"
