...
Delegates to core.models.stock_screener.
"""
...
import core.models.stock_screener as _core_mod
from core.models.stock_screener import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "models.stock_screener".replace(".", "/") + ".py"
