...
Delegates to core.models.strategy_evaluator.
"""
...
import core.models.strategy_evaluator as _core_mod
from core.models.strategy_evaluator import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "models.strategy_evaluator".replace(".", "/") + ".py"
