...
Delegates to core.models.quality_gates.
"""
...
import core.models.quality_gates as _core_mod
from core.models.quality_gates import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "models.quality_gates".replace(".", "/") + ".py"
