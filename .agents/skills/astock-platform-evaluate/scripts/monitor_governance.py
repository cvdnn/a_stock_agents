...
Delegates to core.models.monitor_governance.
"""
...
import core.models.monitor_governance as _core_mod
from core.models.monitor_governance import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "models.monitor_governance".replace(".", "/") + ".py"
