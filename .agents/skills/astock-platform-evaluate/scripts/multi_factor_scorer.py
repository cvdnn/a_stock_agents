...
Delegates to core.models.multi_factor_scorer.
"""
...
import core.models.multi_factor_scorer as _core_mod
from core.models.multi_factor_scorer import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "models.multi_factor_scorer".replace(".", "/") + ".py"
