...
Delegates to core.models.base_algorithm.
"""
...
import core.models.base_algorithm as _core_mod
from core.models.base_algorithm import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "models.base_algorithm".replace(".", "/") + ".py"
