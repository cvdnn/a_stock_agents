...
Delegates to core.models.market_assessor.
"""
...
import core.models.market_assessor as _core_mod
from core.models.market_assessor import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "models.market_assessor".replace(".", "/") + ".py"
