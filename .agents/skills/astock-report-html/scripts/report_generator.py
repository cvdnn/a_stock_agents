...
Delegates to core.reporting.report_generator.
"""
...
import core.reporting.report_generator as _core_mod
from core.reporting.report_generator import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "reporting.report_generator".replace(".", "/") + ".py"
