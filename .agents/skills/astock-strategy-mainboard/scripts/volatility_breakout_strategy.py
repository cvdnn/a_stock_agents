...
Delegates to core.strategy.volatility_breakout_strategy.
"""
...
import core.strategy.volatility_breakout_strategy as _core_mod
from core.strategy.volatility_breakout_strategy import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "strategy.volatility_breakout_strategy".replace(".", "/") + ".py"
        _target_file = (_ROOT / "scripts" / "core" if (_ROOT / "scripts" / "core").exists() else _ROOT / "core") / _rel
