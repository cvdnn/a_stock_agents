...
Delegates to core.strategy.pool_schema.
"""
...
import core.strategy.pool_schema as _core_mod
from core.strategy.pool_schema import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "strategy.pool_schema".replace(".", "/") + ".py"
