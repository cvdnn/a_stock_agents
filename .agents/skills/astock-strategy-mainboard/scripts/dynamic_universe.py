...
Delegates to core.strategy.dynamic_universe.
"""
...
import core.strategy.dynamic_universe as _core_mod
from core.strategy.dynamic_universe import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "strategy.dynamic_universe".replace(".", "/") + ".py"
