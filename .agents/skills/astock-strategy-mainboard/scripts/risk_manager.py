...
Delegates to core.strategy.risk_manager.
"""
...
import core.strategy.risk_manager as _core_mod
from core.strategy.risk_manager import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "strategy.risk_manager".replace(".", "/") + ".py"
