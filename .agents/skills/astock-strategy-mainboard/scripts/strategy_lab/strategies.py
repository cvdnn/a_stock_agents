...
Delegates to core.strategy.strategy_lab.strategies.
"""
...
import core.strategy.strategy_lab.strategies as _core_mod
from core.strategy.strategy_lab.strategies import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _target_file = (_ROOT / "scripts" / "core" if (_ROOT / "scripts" / "core").exists() else _ROOT / "core") / "strategy/strategy_lab/strategies.py"
