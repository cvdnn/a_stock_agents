...
Delegates to core.strategy.grid_trading_strategy.
"""
...
import core.strategy.grid_trading_strategy as _core_mod
from core.strategy.grid_trading_strategy import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "strategy.grid_trading_strategy".replace(".", "/") + ".py"
