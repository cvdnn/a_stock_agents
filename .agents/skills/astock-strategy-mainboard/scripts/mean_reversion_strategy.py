...
Delegates to core.strategy.mean_reversion_strategy.
"""
...
import core.strategy.mean_reversion_strategy as _core_mod
from core.strategy.mean_reversion_strategy import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "strategy.mean_reversion_strategy".replace(".", "/") + ".py"
