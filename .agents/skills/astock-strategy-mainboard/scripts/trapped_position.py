...
Delegates to core.strategy.trapped_position.
"""
...
import core.strategy.trapped_position as _core_mod
from core.strategy.trapped_position import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "strategy.trapped_position".replace(".", "/") + ".py"
