...
Delegates to core.data.data_source_registry.
"""
...
import core.data.data_source_registry as _core_mod
from core.data.data_source_registry import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "data.data_source_registry".replace(".", "/") + ".py"
