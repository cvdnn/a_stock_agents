...
Delegates to core.indicators.technical_indicators.
"""
...
import core.indicators.technical_indicators as _core_mod
from core.indicators.technical_indicators import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "indicators.technical_indicators".replace(".", "/") + ".py"
