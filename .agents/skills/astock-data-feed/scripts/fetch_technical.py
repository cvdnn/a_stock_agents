...
Delegates to core.data.fetch_technical.
"""
...
import core.data.fetch_technical as _core_mod
from core.data.fetch_technical import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _target_file = (_ROOT / "scripts" / "core" if (_ROOT / "scripts" / "core").exists() else _ROOT / "core") / "data/fetch_technical.py"
