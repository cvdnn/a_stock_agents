...
Delegates to core.multi_agent.ta_entry_monitor.
"""
...
import core.multi_agent.ta_entry_monitor as _core_mod
from core.multi_agent.ta_entry_monitor import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _rel = "multi_agent.ta_entry_monitor".replace(".", "/") + ".py"
