...
Delegates to core.models.factor_synthesizer.
"""
...
import core.models.factor_synthesizer as _core_mod
from core.models.factor_synthesizer import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _target_file = (_ROOT / "scripts" / "core" if (_ROOT / "scripts" / "core").exists() else _ROOT / "core") / "models/factor_synthesizer.py"
