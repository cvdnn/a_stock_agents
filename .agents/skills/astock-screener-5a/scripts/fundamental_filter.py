...
Delegates to core.strategy.fundamental_filter.
"""
...
import core.strategy.fundamental_filter as _core_mod
from core.strategy.fundamental_filter import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _target_file = (_ROOT / "scripts" / "core" if (_ROOT / "scripts" / "core").exists() else _ROOT / "core") / "strategy/fundamental_filter.py"
