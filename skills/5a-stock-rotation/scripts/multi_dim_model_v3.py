...
Delegates to core.models.multi_dim_model_v3.
"""
...
import core.models.multi_dim_model_v3 as _core_mod
from core.models.multi_dim_model_v3 import *  # noqa: F401, F403
...
if __name__ == "__main__":
    if hasattr(_core_mod, "main") and callable(getattr(_core_mod, "main")):
        ...
        import runpy
        _target_file = _ROOT / "core/models/multi_dim_model_v3.py"
