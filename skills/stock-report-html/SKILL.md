...
```
skills/a-share-data/templates/stock-report.html
```
...
# 1. 读取模板
html = Path(Path.home() / ".AI-Platform/skills/stocks/a-share-data/templates/stock-report.html").read_text()
...
# 3. 保存到日期目录并弹出
DATE_DIR = Path("/mnt/c/Users/user/coding/AAAAA") / "20260730"
