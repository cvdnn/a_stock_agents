...
assert(html.includes('<span class="section-num-badge">1</span>'), '板块 1 必须具备序号徽章 1');
...
console.log('✅ PASS: 板块 1 【投资概要】定位、全景账户画像、Donut 环形图与实战风控总览断言全部通过');
...
assert(html.includes('<span class="section-num-badge">2-1</span>'), '板块 2-1 必须具备序号徽章 2-1');
...
console.log('✅ PASS: 板块 2-1 【大盘指数】四大核心指数与 28 周期 Sparkline 走势微图断言全部通过');
...
assert(html.includes('<span class="section-num-badge">2-2</span>'), '板块 2-2 必须具备序号徽章 2-2');
...
console.log('✅ PASS: 板块 2-2 【行情分析】情绪仪表盘、两市总成交、红涨绿跌分布与赚钱效应断言全部通过');
...
assert(html.includes('<span class="section-num-badge">3-1</span>'), '板块 3-1 必须具备序号徽章 3-1');
...
console.log('✅ PASS: 板块 3-1 【自选指数】半导体/AI/新能源主题分时曲线与成分股列表断言全部通过');
...
assert(html.includes('<span class="section-num-badge">3-2</span>'), '板块 3-2 必须具备序号徽章 3-2');
...
console.log('✅ PASS: 板块 3-2 【投资分析】夏普比率/胜率/最大回撤与策略净值对比折线图断言全部通过');
...
assert(html.includes('<span class="section-num-badge">4</span>'), '板块 4 必须具备序号徽章 4');
...
console.log('✅ PASS: 板块 4 【盯盘】高频策略异动事件流与策略触发通道断言全部通过');
