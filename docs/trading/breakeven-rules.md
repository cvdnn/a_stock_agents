...
> 🔗 **权威知识与实施看板**：本文件为实操速查指引。完整数学模型与规则定义请参阅 [`docs/guidelines/business/breakeven-calculation-rules.md`](../guidelines/business/breakeven-calculation-rules.md)，实施与执行看板请参阅 [`docs/specs/business/biz-breakeven-price-calculation-rules.md`](../specs/business/biz-breakeven-price-calculation-rules.md) (SPEC-BIZ-002)。
