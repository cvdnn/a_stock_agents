...
- **Web UI 界面设计与交互规范**：[`specs/ui/ui-design-and-interaction-plan.md`](specs/ui/ui-design-and-interaction-plan.md) (SPEC-UI-001)
...
- **A2UI 前端动态渲染引擎规范**：[`specs/a2ui/a2ui-framework-engine-plan.md`](specs/a2ui/a2ui-framework-engine-plan.md) (SPEC-A2UI-001)
- **最低保本卖出价精算数学规则**：[`specs/business/biz-breakeven-price-calculation-plan.md`](specs/business/biz-breakeven-price-calculation-plan.md) (SPEC-BIZ-002)
...
- **算法资产全生命周期治理体系**：[`specs/algorithm/algo-lifecycle-and-governance-plan.md`](specs/algorithm/algo-lifecycle-and-governance-plan.md) (SPEC-ALGO-001)
